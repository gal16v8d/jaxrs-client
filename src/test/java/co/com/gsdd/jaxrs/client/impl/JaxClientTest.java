...
public class JaxClientTest {
    ...
    public void getTest_shouldGetExistingObject_whenNoResponseType() throws Exception {
        ...
        Response response = jaxClientSpy.invokeGet(new RestCallBuilder(LOCAL_DYNAMIC_PATH.toString()).errorMsg(ERROR)
                .acceptedMimeType(APPLICATION_JSON).build());
    ...
    public void getTest_shouldGetAndNoReturnEntity() throws Exception {
        ...
        Mockito.when(builderMock.get()).thenReturn(response);
        jaxClientSpy.get(
                new RestCallBuilder(LOCAL_DYNAMIC_PATH.toString()).user("admin").pass(null).errorMsg(ERROR).build());
        Mockito.verify(jaxClientSpy).callEndpointAndGetEntity(Mockito.eq(response), Mockito.any(RestCallParams.class),
                Mockito.eq(null));
        Mockito.verify(response).close();
    }
    ...
    public void getTest_shouldGetAndRetrieveExistingObject_whenNoClass() throws Exception {
        ...
        Mockito.when(builderMock.get()).thenReturn(response);
        Class<?> clazz = null;
        Object actual = jaxClientSpy
                .get(new RestCallBuilder(LOCAL_DYNAMIC_PATH.toString()).user("admin").pass("admin").build(), clazz);
    ...
    public void getTestShouldLaunchHttpClientExcWhenInvokeFailTest() {
        ...
        Class<?> clazz = null;
        HTTPClientException e = Assertions.assertThrows(HTTPClientException.class, () -> jaxClientSpy
                .get(new RestCallBuilder(LOCAL_PATH.toString()).user("admin").pass("admin").build(), clazz));
        Assertions.assertEquals("Error when execute GET method for target -> 'http://localhost:1080/path' . Error",
                e.getMessage());
    }
    ...
    public void postTest_shouldCreateObject_whenInformationIsValid() throws Exception {
        ...
        Response response = jaxClientSpy.invokePost(
                new RestCallBuilder(LOCAL_PATH.toString()).errorMsg(ERROR).payload(serviceContentResponse).build());
    ...
    public void postTest_shouldPostAndNoReturnEntity() throws Exception {
        ...
        Mockito.when(builderMock.post(Mockito.any())).thenReturn(response);
        jaxClientSpy.post(
                new RestCallBuilder(LOCAL_PATH.toString()).payload(serviceContentResponse).errorMsg(ERROR).build());
        Mockito.verify(jaxClientSpy).callEndpointAndGetEntity(Mockito.eq(response), Mockito.any(RestCallParams.class),
                Mockito.eq(null));
        Mockito.verify(response).close();
    }
    ...
    public void postTestShouldLaunchHttpClientExcWhenInvokeFailTest() {
        ...
        HTTPClientException e = Assertions.assertThrows(HTTPClientException.class,
                () -> jaxClientSpy.post(
                        new RestCallBuilder(LOCAL_PATH.toString()).payload(serviceContentResponse).build(),
                        ServiceResponse.class));
        Assertions.assertEquals("Error when execute POST method for target -> 'http://localhost:1080/path' . Error",
                e.getMessage());
    }
    ...
    public void putTest_shouldUpdateObject_whenInformationIsValid() throws Exception {
        ...
        Response response = jaxClientSpy.invokePut(new RestCallBuilder(LOCAL_DYNAMIC_PATH.toString()).errorMsg(ERROR)
                .payload(serviceContentResponse).build());
        Assertions.assertEquals(Status.OK.getStatusCode(), response.getStatus());
        Assertions.assertNotNull(response.getEntity());
    }
    ...
    public void putTestShouldLaunchHttpClientExcWhenInvokeFailTest() {
        ...
        HTTPClientException e = Assertions.assertThrows(HTTPClientException.class,
                () -> jaxClientSpy.put(
                        new RestCallBuilder(LOCAL_PATH.toString()).payload(serviceContentResponse).build(),
                        ServiceResponse.class));
        Assertions.assertEquals("Error when execute PUT method for target -> 'http://localhost:1080/path' . Error",
                e.getMessage());
    }
    ...
    public void patchTest_shouldUpdateObject_whenInformationIsValid() throws Exception {
        ...
        Response response = jaxClientSpy.invokePatch(new RestCallBuilder(LOCAL_DYNAMIC_PATH.toString()).errorMsg(ERROR)
                .payload(serviceContentResponse).build());
        Assertions.assertEquals(Status.OK.getStatusCode(), response.getStatus());
        Assertions.assertNotNull(response.getEntity());
    }
    ...
    public void patchTestShouldLaunchHttpClientExcWhenInvokeFailTest() {
        ...
        HTTPClientException e = Assertions.assertThrows(HTTPClientException.class,
                () -> jaxClientSpy.patch(
                        new RestCallBuilder(LOCAL_PATH.toString()).payload(serviceContentResponse).build(),
                        ServiceResponse.class));
        Assertions.assertEquals("Error when execute PATCH method for target -> 'http://localhost:1080/path' . Error",
                e.getMessage());
    }
    ...
    public void deleteTest_shouldDeleteAndRetrieveObjectGeneric() throws Exception {
        ...
        ServiceResponse serviceResponse = jaxClientSpy.delete(
                new RestCallBuilder(LOCAL_DYNAMIC_PATH.toString()).build(), new GenericType<>(ServiceResponse.class));
        assertServiceContentResponse(serviceResponse);
        Mockito.verify(response).close();
    }
    ...
    public void deleteTestShouldLaunchHttpClientExcWhenInvokeFailTest() {
        ...
        HTTPClientException e = Assertions.assertThrows(HTTPClientException.class,
                () -> jaxClientSpy.delete(new RestCallBuilder(LOCAL_PATH.toString()).errorMsg(ERROR).build()));
        Assertions.assertEquals("Error when execute DELETE method for target -> 'http://localhost:1080/path' . Error",
                e.getMessage());
    }
    ...
    private void arrangeResponseMock(int statusCode, ServiceResponse serviceContentResponse) {
        ...
        Mockito.when(response.readEntity(new GenericType<>(ServiceResponse.class))).thenReturn(serviceContentResponse);
    }
