package com.gsdd.jaxrs.client.builder;

import java.net.URI;
import javax.ws.rs.client.ClientBuilder;
import javax.ws.rs.core.MediaType;
import com.gsdd.jaxrs.client.HTTPResponseHandler;
import com.gsdd.jaxrs.client.impl.DefaultResponseHandler;
import com.gsdd.jaxrs.client.util.FileNameUtils;
...
public class RestCallParams {
  ...
  /**
   * This builder class allows to send the endpoint target, auth, mediatype and even custom error
   * message for call any service.
   * 
  ...
  public static class RestCallBuilder {
     ...
     * 
     * @param target the root uri for the endpoint.
     ...
     * 
     * @param user for basic auth endpoint call
     ...
     * 
     * @param pass for basic auth endpoint call
     ...
     * 
     * @param acceptedMimeType For example: {@link javax.ws.rs.core.MediaType.APPLICATION_JSON,
     ...
     * 
     * @param errorMsg the custom error message to return.
     ...
     * 
     * @param payload the data to sent to server/service.
     ...
     * 
     * @param responseHandler the responseHandler for processing our response.
