...
public interface HTTPClient {
  ...
  /**
   * Invokes HTTP GET for the given URI. (it properly handles the response for close it when not
   * need it). If response is null or the status code is an error code we throw a
   * HTTPClientException
   * 
   * @param <E>
   * @param params params to send to endpoint like auth, mimetype, custom error message, etc.
   * @param entity the object that we expect as return of the call.
  ...
  /**
   * Invokes HTTP POST for the given URI. (it properly handles the response for close it when not
   * need itt). If response is null or the status code is an error code we throw a
   * HTTPClientException
   * 
   * @param params params to send to endpoint like auth, mimetype, custom error message, etc.
   * @param entity the object that we expect as return of the call.
  ...
  /**
   * Invokes HTTP PUT for the given URI. (it properly handles the response for close it when not
   * need it). If response is null or the status code is an error code we throw a
   * HTTPClientException
   * 
   * @param params params to send to endpoint like auth, mimetype, custom error message, etc.
  ...
  /**
   * Invokes HTTP PATCH for the given URI. (it properly handles the response for close it when not
   * need it). If response is null or the status code is an error code we throw a
   * HTTPClientException
   * 
   * @param params params to send to endpoint like auth, mimetype, custom error message, etc.
  ...
  /**
   * Invokes HTTP DELETE for the given URI. (it properly handles the response for close it when not
   * need it). If response is null or the status code is an error code we throw a
   * HTTPClientException
   * 
   * @param params params to send to endpoint like auth, mimetype, custom error message, etc.
  ...
  /**
   * Allows to close the client on demand. Should be used at finally block for ensure the client
